...
public class BookAdapterMap extends RecyclerView.Adapter<BookAdapterMap.MyViewHolder> {

    private Context mContext;
    private List<Book> bookList;

    public class MyViewHolder extends RecyclerView.ViewHolder {
        public TextView title, owner;
    ...
    public BookAdapterMap( Context mContext, List<Book> bookList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.book_card_map, parent, false);
