...
public class ProfileImageEffect extends CoordinatorLayout.Behavior<CircleImageView>{
    ...
    public ProfileImageEffect(Context context, AttributeSet attrs) {
        mContext = context;
        init();
    ...
    private void maybeInitProperties(CircleImageView child, View dependency) {
        ...
        if (mFinalXPosition == 0)
            mFinalXPosition = 4*mContext.getResources().getDimensionPixelOffset(R.dimen.abc_action_bar_content_inset_material) + (finalHeight / 2);
