...
public class ComedyHome extends Fragment {
    ...
    public ComedyHome() {
        ...
        //recyclerView.addItemDecoration(new gmads.it.gmads_lab1.HomePackage.Home.GridSpacingItemDecoration(2, dpToPx(10), true));
    ...
    public void fetchdata() {
        Query query = new Query(text)
                ...
                .setHitsPerPage(20).setFilters("categories:comedy OR categories:commedia");
