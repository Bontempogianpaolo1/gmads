...
public class AllHome extends Fragment {
    ...
    public void fetchdata() {
        Query query = new Query(text)
                .setAroundLatLng(new AbstractQuery.LatLng(profile.getLat(), profile.getLng())).setGetRankingInfo(true).setPage(npage).setHitsPerPage(20);
        ...
        if(e==null){
            ...
            ImageView notfound = getActivity().findViewById(R.id.not_found);
        ...
        adapter.notifyDataSetChanged();
           ProgressBar p= getActivity().findViewById(R.id.progress_bar);
